...
pwd+=(["foreground"]="colour246")
pwd+=(["background"]="colour255")
...
if [[ ${now_playing["script"]} ]]; then
	now_playing+=(["foreground"]="colour250")
...
battery+=(["foreground"]="colour254")
battery+=(["background"]="colour242")
...
time+=(["foreground"]="colour238")
time+=(["background"]="colour252")
...
date_full+=(["foreground"]="colour238")
date_full+=(["background"]="colour252")
...
date_day+=(["foreground"]="colour238")
date_day+=(["background"]="colour252")
